...
| ScanSnap iX500 | `0x04c5/0x132b` | Validated on hardware (simplex/duplex, color/gray/lineart, 150–600 dpi, 14-sheet batch with auto length detection, scanner buffering, hardware JPEG, empty feeder) |
